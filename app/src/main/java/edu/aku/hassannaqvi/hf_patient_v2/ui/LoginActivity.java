...
import static edu.aku.hassannaqvi.hf_patient_v2.core.MainApp.editor;
import static edu.aku.hassannaqvi.hf_patient_v2.core.MainApp.sharedPref;
import static edu.aku.hassannaqvi.hf_patient_v2.database.CreateTable.DATABASE_COPY;
import static edu.aku.hassannaqvi.hf_patient_v2.database.CreateTable.DATABASE_NAME;
...
import edu.aku.hassannaqvi.hf_patient_v2.core.AppInfo;
import edu.aku.hassannaqvi.hf_patient_v2.core.MainApp;
import edu.aku.hassannaqvi.hf_patient_v2.database.DatabaseHelper;
import edu.aku.hassannaqvi.hf_patient_v2.databinding.ActivityLoginBinding;
...
//            bi.password.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_lock_open, 0, 0, 0);
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.hf_patient_v2.ui.SyncActivity.class).putExtra("login", true));
        } else {
