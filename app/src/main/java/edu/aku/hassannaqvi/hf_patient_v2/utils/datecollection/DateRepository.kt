package edu.aku.hassannaqvi.hf_patient_v2.utils.datecollection
...
class DateRepository {
    ...
    companion object {
        ...
        fun dateValidator(year: Int, month: Int, day: Int): Boolean =
            getDate(year, month, day) != null
        ...
        fun getDOBFromAge(
            ...
            return run {
                refDate.minusYears(year.toLong()).minusMonths(month.toLong())
