package edu.aku.hassannaqvi.hf_patient_v2.utils
...
import edu.aku.hassannaqvi.hf_patient_v2.CONSTANTS
import edu.aku.hassannaqvi.hf_patient_v2.R
import edu.aku.hassannaqvi.hf_patient_v2.core.MainApp.PROJECT_NAME
import edu.aku.hassannaqvi.hf_patient_v2.database.CreateTable.DATABASE_COPY
import edu.aku.hassannaqvi.hf_patient_v2.database.CreateTable.DATABASE_NAME
import edu.aku.hassannaqvi.hf_patient_v2.databinding.EndSectionDialogBinding
import edu.aku.hassannaqvi.hf_patient_v2.ui.EndingActivity
import edu.aku.hassannaqvi.hf_patient_v2.utils.extension.gotoActivityWithSerializable
import java.io.*
...
@JvmOverloads
fun AppCompatActivity.openWarningDialog(
    title: String,
    message: String,
    btnYesTxt: String = "OK",
    btn: RadioGroup
...
fun AppCompatActivity.openWarningDialog(title: String, response: Int, message: String) {
    ...
    bi.btnOk.setOnClickListener {
        gotoActivityWithSerializable(
            ...
            CONSTANTS.SECTION_MAIN_CHECK_FOR_END,
            response
        )
    }
    bi.btnNo.setOnClickListener {
